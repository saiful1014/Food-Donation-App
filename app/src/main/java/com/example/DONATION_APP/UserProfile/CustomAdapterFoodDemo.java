...
public class CustomAdapterFoodDemo extends BaseAdapter {
    ...
    public CustomAdapterFoodDemo(Context context, String[] endTimeString, String[] startTimeSting) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        {
            ...
            convertView = inflater.inflate(R.layout.simple_food_demo, parent, false);
        }
